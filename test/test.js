...
describe('Application life cycle test', function () {
    ...
    it('can upload file with sftp', function () {
        ...
        //     HashKnownHosts no
        if (!process.env.CI) execSync(util.format('sed -i \'/%s/d\' -i ~/.ssh/known_hosts', app.fqdn));
    ...
    it('can access phpmyadmin', checkPhpMyAdmin);
    it('can access ioncube', checkIonCube);
    it('can check PHP version', checkPhpVersion.bind(null, '8.3')); // will change to 8.3 next release
